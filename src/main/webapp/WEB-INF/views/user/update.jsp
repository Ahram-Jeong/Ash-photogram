			...
			<form id="profileUpdate" onsubmit="update(${principal.user.id}, event)">
				<div class="content-item__02">
					...
					<div class="item__input">
						<input type="text" name="name" placeholder="이름" value="${principal.user.name}" required/>
					</div>
				</div>
				<div class="content-item__03">
					<div class="item__title">ID</div>
					<div class="item__input">
						<input type="text" name="username" placeholder="아이디" value="${principal.user.username}" readonly="readonly" />
					</div>
				</div>
